...
- [x] Aggiungere **semplificazioni** - ove possibili - nell'algoritmo (e.g. trucchi per evitare l'ingresso della variabile artificiale, etc.).
- [x] Aggiungere l'**analisi della sensitività** in: simplesso, dualità.
