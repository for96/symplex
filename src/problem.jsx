      ...
      {isOptimal && Frac && (
        <div className="opt-block">
          <div className="opt-row">
            <span className="opt-label">{t.optimalPrimal}</span>
            <span className="opt-vals">
              {xStar.map((v, j) => (
                <React.Fragment key={j}>
                  ...
                  <span className="eq">=</span>
                  <Frac value={v} />
                  {j < xStar.length - 1 && <span className="sep">,</span>}
                </React.Fragment>
              ))}
            </span>
          </div>
          <div className="opt-row">
            <span className="opt-label">{t.optimalDual}</span>
            <span className="opt-vals">
              {yStar.map((v, i) => (
                <React.Fragment key={i}>
                  <VarName name={`y_${i + 1}`} />
                  ...
                  <span className="eq">=</span>
                  <Frac value={v} />
                  {i < yStar.length - 1 && <span className="sep">,</span>}
                </React.Fragment>
              ))}
            </span>
          </div>
          <div className="opt-row">
            <span className="opt-label">z*</span>
            <span className="opt-vals">
              <Frac value={zStar} />
            </span>
          </div>
